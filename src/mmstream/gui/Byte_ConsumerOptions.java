...
public class Byte_ConsumerOptions implements ConsumerOptions{

  public Byte_ConsumerOptions() {
    panelbuilt = false;
    Options = null;
    appMan = null;
  }
  ...
  createConsumer(Session ses)     throws Gui_Exception {
    if (panelbuilt == false) 
      throw new Gui_Exception("Byte_ConsumerOptions.createConsumer():not initialised");

    Byte_Consumer consumer = null;
    consumer = new Byte_Consumer(appMan, ses, String.valueOf(appMan.getUniqueId()));
    return consumer;
  }
  ...
  createConsumer(Session ses, StreamExporter exp)     throws Gui_Exception {
    ...
    return new Byte_Consumer(appMan, ses, exp, String.valueOf(appMan.getUniqueId()));
  }
  ...
  public static final String Name = new String(Consumer_TypeConfiguration.BYTE_Name);
}
